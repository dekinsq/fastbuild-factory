...
public class YudaoSqlServerFormat extends AbstractFormat {

    private final String GEN_ID = "yudao#sqlserver";

    public YudaoSqlServerFormat(AppConfig app) {
        super(app);
    }
    ...
    protected boolean validate() {
        return (FactoryConst.app.YUDAO.equals(app.getAppId())
                && FactoryConst.db.SQL_SERVER.equals(project.getDatabase()));
    }
